...
unsigned int Desenho::desenha_predio() {
    ...
    float frontal_comprimento = 20.0, frontal_altura = 7.0;
    float lateral_comprimento = 10.0, lateral_altura = 7.0;
    ...
    glPushMatrix();
    desloc_x = 0;
    desloc_y = proporcao * frontal_altura / 2.0;
    desloc_z = 0;
    ...
    desloc_x = 0;
    desloc_y = proporcao * frontal_altura / 2.0;
    desloc_z = -proporcao * lateral_comprimento;
    glTranslatef (desloc_x, desloc_y, desloc_z);
    glScalef (frontal_comprimento, frontal_altura, parede_largura);
    glutSolidCube (proporcao);
    glPopMatrix();
    ...
    glPushMatrix();
    desloc_x = -proporcao * frontal_comprimento / 2.0;
    desloc_y = proporcao * lateral_altura / 2.0;
    desloc_z = -proporcao * lateral_comprimento / 2.0;
    glTranslatef (desloc_x, desloc_y, desloc_z);
    glRotatef (90, 0, 1, 0);
